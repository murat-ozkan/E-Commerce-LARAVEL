        ...
        <div class="container">
            <div class="row align-items-start align-items-md-center justify-content-end">
                <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                    <h1 class="mb-2">{{ $slider->name ?? 'Default Value' }}</h1>
                    <div class="intro-text text-center text-md-left">
                        <p class="mb-4">{{ $slider->content ?? 'Default Value' }}</p>
                        <p>
                            <a href="{{ url('/') . '/' . $slider->link }}" class="btn btn-sm btn-primary">Go To Products</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-4 mb-5 mb-lg-0" data-aos="fade" data-aos-delay="100">
                    <a class="block-2-item" href="{{ route('childrenproducts') }}">
                        <figure class="image">
